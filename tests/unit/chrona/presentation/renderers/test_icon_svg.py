from chrona.presentation.icons import IconPathCommand, NormalizedIconPath, NormalizedVectorIcon, normalize_icon
...
def test_svg_serializes_completed_stroke_icon_path_with_layout_scale():
    vector = NormalizedVectorIcon((24, 24), (
        NormalizedIconPath((IconPathCommand("move", ((0, 0),)), IconPathCommand("line", ((24, 24),))),
                           "stroke", 2.0, "round", "bevel"),
    ))
    icon = ScenePrimitive("i", "Icon", "risk", "object", "icon-mark", "planned", (1, 2, 12, 12),
                          paint=ScenePaint("#123456", None, None, (), 1.0), icon_kind="vector",
                          icon_asset_identity="sha256:" + "a" * 64, icon_vector=vector,
                          icon_alternative="Risk", icon_decorative=False, icon_stroke_scale=0.5)
    svg = render_v05_svg(_surface(icon), viewport=(24, 24))
