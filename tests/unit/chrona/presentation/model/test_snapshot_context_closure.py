...
def test_v06_closure_allows_named_snapshot_project_at_its_own_revision(tmp_path, monkeypatch):
    primary = {"version": "timeline/v0.5", "project": {"id": "p"}, "objects": {}}
    historic = {"version": "timeline/v0.5", "project": {"id": "p"}, "objects": {}}
    ...
    for name, kind in (("view", "view"), ("theme", "theme"), ("scheme", "color-scheme"), ("layout", "layout-profile")):
        versions = {
            "view": "chrona/view/v0.8", "theme": "chrona/theme/v0.3",
            "color-scheme": "chrona/color-scheme/v0.1", "layout-profile": "chrona/layout-profile/v0.3",
        }
