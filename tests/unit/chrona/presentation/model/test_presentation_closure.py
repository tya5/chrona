...
def test_v05_closure_binds_theme_scheme_and_layout_separately(tmp_path):
    ...
    view = {"version": "chrona/view/v0.17", "kind": "view", "id": "v", "body": {}}
    ...
    layout = {"version": "chrona/layout-profile/v0.7", "id": "l", "writingMode": "horizontal-tb", "requiredThemeTokens": [], "reviewSurface": {"rowDistribution": "pack", "backgroundExtents": {"rowBand": "table", "groupBand": "timeline", "groupHeaderBand": "both", "calendarClosed": "timeline"}, "annotationRouting": {"maxBends": 4, "maxDetourRatio": 2}}, "root": {}}
    refs = {}
