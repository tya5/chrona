...
def _surface_content_input(projection: ReviewProjection, project: dict[str, Any], view: dict[str, Any], settings: dict[str, Any], summary_profile: dict[str, Any] | None = None, as_of: date | None = None, detail_profile: dict[str, Any] | None = None):
    ...
    from chrona.presentation.review_detail import resolve_review_detail_profile
...
def render_table_timeline_svg(title: str, projection: ReviewProjection, project: dict[str, Any], view: dict[str, Any], theme: dict[str, Any], capabilities: set[str], profile: dict[str, Any], slots: dict[str, Any] | None = None, settings: dict[str, Any] | None = None, surface_content: Any | None = None) -> str:
    ...
    from chrona.presentation.gantt_surface import render_gantt
    required = {"sourceMetadata", "accessibleText", "semanticRoles", "marker", "tableSemantics", "hierarchicalAxis"}
    if not required.issubset(capabilities):
        raise ValueError("E_OUTPUT_CAPABILITY_MISSING")
    presentation_scene = None
    if settings is not None:
        from chrona.presentation.presentation_scene import build_presentation_scene
