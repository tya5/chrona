...
from chrona.presentation.presentation_axis import AxisInterval, axis_intervals, format_axis_label
from chrona.presentation.presentation_marks import ComparisonMark, comparison_marks
from chrona.presentation.presentation_lanes import LaneAssignment, LaneItem, LaneTrack, assign_stable_lanes, lane_tracks
from chrona.presentation.presentation_layout import solve_presentation_layout
from chrona.presentation.font_metrics import FontMetrics, resolve_font_metrics
from chrona.presentation.presentation_routing import route_orthogonal
...
def _surface_primitives(surface: SceneSurface, title: str, items: tuple[object, ...],
    ...
    if surface.surface_id in {"table-timeline", "review", "minimal"}:
        ...
        if content.annotations:
            from chrona.presentation.presentation_annotations import (nearest_box_port, project_annotation_box,
                                                   resolve_annotation_anchor, route_annotation_leader)
            from chrona.presentation.presentation_labels import LabelRect
