...
`src/chrona/presentation/layout/axis.py` adds renderer-independent Date-only intervals. It
...
`tests/unit/chrona/presentation/layout/test_presentation_axis.py` verifies window boundaries, ISO week-years, tick
