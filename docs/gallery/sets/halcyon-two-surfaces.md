...
![Dependency network](../../../examples/halcyon-1/generated/05-dependency-network.svg)

Corpus: `halcyon-1` · slide: `dependency-network` · [Context](../../../examples/halcyon-1/contexts/05-dependency-network.yaml)

## Presentation-reference diff

- `view`: `halcyon-02-programme-board` → `halcyon-05-dependency-network`
- `theme`: `wallboard` → `briefing`
- `colorScheme`: `control-room-dark` → `mission-light`
