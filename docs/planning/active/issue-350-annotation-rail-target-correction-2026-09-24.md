...
**Status:** Superseded in part — see Measured Annotation Rail Allocation correction.
...
in its footer flow after its measured allocation is available.  This is an annotation rail, not a View coordinate system:
