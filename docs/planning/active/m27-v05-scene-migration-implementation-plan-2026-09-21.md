...
|---|---|---|
| I27-R1 | `ThemeTokenView`, v0.5 Scene builder input seam, and missing token/input diagnostics | typed token tests; no legacy settings/paint shape import; full regression |
...
Every slice begins with executable evidence, consumes only the Specification 37
