...
| M27 | In progress | Materializer/reproduction is complete, but `m27-rich-primitive-acceptance-design-amendment-2026-09-21.md` reopens role typography, annotation leaders, and dependency markers. | Complete I27-R6 and A27-01/A27-05 before #29/#33 closure. |
