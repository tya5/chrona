...
| M24 | I24-1–I24-3 complete; I24-4 authorized after source-boundary correction | Profile resolution at `fcabf30`; normal flow at `df2844e`; per-axis correction at `cc60472`; relative solver at `5567383`. I24-4 audit closed the previously unspecified source measure/compose and Theme metric boundary before product-path code. | Publish the source-adapter addendum, then replace the product path atomically. |
