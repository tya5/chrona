...
| M24 | Implementation planned; not started | L24-D1–D3 published at `9cd4324`; `m24-intent-layout-implementation-plan-2026-09-20.md` maps Specification 33 to I24-1–I24-5. | Publish the implementation plan, then execute I24-1 through I24-5 serially. |
