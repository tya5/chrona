...
| M24 | I24-1–I24-2 complete; I24-3 authorized | Profile resolution at `fcabf30`; normal flow at `df2844e`; per-axis target design addendum closes the guide/barrier ambiguity before relative-placement code. | Publish the addendum, then implement anchors/guides/barriers. |
