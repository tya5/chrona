...
| M27 | Implementation planned | I27-R1 is reclosed with required immutable `MeasuredSources`; the I27-R2 ISO axis fit rule is design-closed by `m27-axis-policy-design-amendment-2026-09-21.md`. | Complete I27-R2–I27-R5 and A27-01–A27-10. |
