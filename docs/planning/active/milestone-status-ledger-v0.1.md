...
| M27 | In progress | I27-R1/R2/R3A/R3B1/R4 are complete: frozen seam, core SceneSurface, SVG adapter, normalized optional content, and CLI switch; review: `m27-i27-r3b1-optional-normalization-review-2026-09-21.md`. | Complete I27-R3B2/R5 and A27-01–A27-10. |
