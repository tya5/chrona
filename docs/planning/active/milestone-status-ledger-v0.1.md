...
| M27 | Design amendment | The completed-Scene implementation was found to depend on removed pre-M24 settings/Theme contracts. `m27-completed-scene-migration-design-amendment-2026-09-21.md` reopens the affected design gates. | Close the v0.5 Scene/token migration design and publish a corrected implementation plan. |
