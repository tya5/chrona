...
| M24 | Design complete; implementation not started | L24-D1 research/use cases, L24-D2 Specification 33/ADR-0023/schemas/fixtures, and L24-D3 whole-design review. | Publish the design commit, then create and publish the implementation plan before changing runtime code. |
