...
| M27 | Implementation planned | The v0.5 Scene/token migration design is closed without a legacy rollback. `m27-v05-scene-migration-implementation-plan-2026-09-21.md` governs I27-R1–I27-R5. | Complete I27-R1–I27-R5 and A27-01–A27-10. |
