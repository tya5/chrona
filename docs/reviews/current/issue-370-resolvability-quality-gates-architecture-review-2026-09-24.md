...
analysis cannot make; exact source anchors prevent broad, code-level
suppression.
...
| Are classifications reviewable and complete? | Yes. Exact policy anchors and stale-entry rejection make the full derived population visible. |

## Required implementation constraints

1. Do not suppress findings with a code-wide diagnostic exception.
