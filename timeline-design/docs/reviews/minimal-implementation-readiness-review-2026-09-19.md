...
| Executable verification | Pass | `PYTHONPATH=src python -m pytest -q` passes 29 tests; `python timeline-design/docs/fixtures/run_conformance.py` passes all fixture suites. |
