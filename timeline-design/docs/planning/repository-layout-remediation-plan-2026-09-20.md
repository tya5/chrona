...
| Current | Target |
|---|---|
| `timeline-design/docs/specification/` | `docs/specification/` |
| `timeline-design/docs/decisions/` | `docs/decisions/` |
| `timeline-design/docs/federation/` | `docs/research/federation/` |
...
| `timeline-design/docs/traceability/` | `docs/traceability/` |
| documentation assets | `docs/assets/` |
| `timeline-design/docs/schemas/` | `schemas/` |
| `timeline-design/docs/fixtures/` | `conformance/` |
| `timeline-design/MANIFEST.json` | `docs/manifest.json` |
| `timeline-design/VALIDATION.json` | `conformance/validation.json` |
