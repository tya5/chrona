...
| M10 | Design complete; implementation not started | DateTime value/DST plus v0.2 Project Format, endpoint, recurrence, migration schema/fixture closure. | Runtime and UC-16 evidence. |
