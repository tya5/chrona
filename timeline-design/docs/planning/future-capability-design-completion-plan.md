...
| FD-2 | **In design:** Resource/capacity, calendars, leveling and cost/time accounting boundary | Domain, Scheduling, Project Format, Quality, schemas, fixtures, ADR | Authority table separating plan/actual/capacity; no hidden auto-leveling; deterministic infeasibility/leveling examples; review. |
