...
### Q-OUTPUT-1 Capability truthfulness

An output adapter MUST declare capabilities before evaluation and preserve each
required source, role, and accessibility distinction or reject/report the exact loss.
Generated bytes and manifests are derived state and MUST NOT become canonical input.
